...
void loop() {
  ...
  if (valorTouch1 < UMBRAL_TOUCH) {
    ...
    display.println("Se esta tocando el pin 1");
    display.println("Numero de pin: ");
    display.println(TOUCH_PIN1);
    ...
    display.setCursor(15, 28);
    display.println("Se esta tocando el pin 2");
     display.println("Numero de pin: ");
    display.println(TOUCH_PIN2);
    ...
    display.println("No se esta tocando el pin");
